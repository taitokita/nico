        ...
        <p class="text">
         ...
         <select  name="tag_id" type="text" class="form-control selectpicker"style="font-size: 18px" >
                           ...
                           <option class="content" data-icon="glyphicon-tag" value="0">&nbsp;&nbsp;Category</option>
            				...
            				<option value="4" name="4"<?php if($shop->tag_id == 4){echo "selected";}?>>Chinese</option>
            				<option value="5" name="5"<?php if($shop->tag_id == 5){echo "selected";}?>>Korean</option>
            				<option value="6" name="6"<?php if($shop->tag_id == 6){echo "selected";}?>>Spanish</option>
            				<option value="7" name="7"<?php if($shop->tag_id == 7){echo "selected";}?>>Indian</option>
            				<option value="8" name="8"<?php if($shop->tag_id == 8){echo "selected";}?>>Ethnic</option>
            				<option value="9" name="9"<?php if($shop->tag_id == 9){echo "selected";}?>>Izakaya・Bar</option>
            				<option value="10" name="10"<?php if($shop->tag_id == 10){echo "selected";}?>>Café</option>
         </select>
         <br>
         <br>
